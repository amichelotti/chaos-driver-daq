...
/*
uint8_t own::CmdBTFdaqAcquire::implementedHandler() {
...
BATCH_COMMAND_OPEN_DESCRIPTION_ALIAS(driver::daq::libera::,CmdBTFdaqAcquire,"acquire","acquire command","72882f3e-36db-11e5-985f-334fcd6dff22")
...
driver::daq::libera::CmdBTFdaqAcquire::CmdBTFdaqAcquire():CmdBTFdaqDefault(){
}
driver::daq::libera::CmdBTFdaqAcquire::~CmdBTFdaqAcquire(){
}
void driver::daq::libera::CmdBTFdaqAcquire::setHandler(c_data::CDataWrapper *data) {
	...
	int ret;
        ...
        acquire_duration=0;
        wait_for_us=0;
        CmdBTFdaqDefault::setHandler(data);
...
void driver::daq::libera::CmdBTFdaqAcquire::acquireHandler() {
...
//}
//
//bool own::CmdBTFdaqAcquire::timeoutHandler() {
