 ...
 */
#ifndef ChaosRTControlUnit_RTBTFSync_h
#define ChaosRTControlUnit_RTBTFSync_h
...
class RTBTFSync : public driver::misc::RTDataSync {
	PUBLISHABLE_CONTROL_UNIT_INTERFACE(RTBTFSync)
public:
    /*!
     Construct a new CU with full constructor
     */
    RTBTFSync(const std::string& _control_unit_id, const std::string& _control_unit_param, const ControlUnitDriverList& _control_unit_drivers);
    /*!
     Destructor a new CU
     */
    ~RTBTFSync();
