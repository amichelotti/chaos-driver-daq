/* 
 * File:   CmdDafneAccumulatorBPM.cpp
 * Author: michelo
 * 
 * Created on October 15, 2015, 10:21 AM
 */

#include "CmdDafneAccumulatorBPM.h"
...
CmdDafneAccumulatorBPM::CmdDafneAccumulatorBPM() {
...
uint8_t CmdDafneAccumulatorBPM::implementedHandler(){
       return chaos::common::batch_command::HandlerType::HT_Set  | chaos::common::batch_command::HandlerType::HT_Acquisition;

}
void  CmdDafneAccumulatorBPM::setHandler(c_data::CDataWrapper *data){
...
void CmdDafneAccumulatorBPM::acquireHandler() {
