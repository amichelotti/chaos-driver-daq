/*
 * LiberaBrillianceSPEpicsDriver.h
 * @author michelo
...
#ifndef __LiberaBrillianceSPEpicsDriver_H__
#define __LiberaBrillianceSPEpicsDriver_H__
#include "LiberaEpicsBase.h"
#include <driver/daq/models/Libera/LiberaData.h>
namespace cu_driver = chaos::cu::driver_manager::driver;
DEFINE_CU_DRIVER_DEFINITION_PROTOTYPE(LiberaBrillianceSPEpicsDriver);
namespace driver {
namespace epics {
namespace common {
...
class LiberaBrillianceSPEpicsDriver : public LiberaEpicsBase{
   uint32_t maxSamples;// epics driver cannot set dinamically size, so the right port is selected on the base of the maxSamples

 public:
  LiberaBrillianceSPEpicsDriver();
