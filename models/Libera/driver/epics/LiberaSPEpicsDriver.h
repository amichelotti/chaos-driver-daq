/*
 * LiberaSPEpicsDriver.h
 * @author michelo
  Copyright January 2022 Andrea Michelotti
 * epics driver for Libera Brilliance Single Pass (new model)+
...
#ifndef __LiberaSPEpicsDriver_H__
#define __LiberaSPEpicsDriver_H__
#include "LiberaEpicsBase.h"
#include <driver/daq/models/Libera/LiberaData.h>
DEFINE_CU_DRIVER_DEFINITION_PROTOTYPE(LiberaSPEpicsDriver);
namespace driver {
namespace epics {
namespace common {
...
class LiberaSPEpicsDriver : public LiberaEpicsBase {
 protected:
