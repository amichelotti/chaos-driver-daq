 ...
 * All Rights Reserved.
 *
 * $Id: mci_read_fa.cpp 22034 2015-06-19 08:32:00Z damijan.skvarc $
 */
...
int main(int a_argc, char* a_argv[])
{
    ...
    /* get registry node referring to FA stream */
    mci::Node node = root.GetNode(mci::Tokenize(cFaStream));

    /* instantiate remote signal entity */
    isig::SignalSourceSharedPtr signal = mci::CreateRemoteSignal(node);

    /* FA signal is stream signal whose basic data type is signed 32 bit */
