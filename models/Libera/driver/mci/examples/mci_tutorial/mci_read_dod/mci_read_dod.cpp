 ...
 * All Rights Reserved.
 *
 * $Id: mci_read_dod.cpp 22034 2015-06-19 08:32:00Z damijan.skvarc $
 */
...
int main(int a_argc, char* a_argv[])
{
    ...
    /* get registry node referring to adc data on demand signal */
    mci::Node node = root.GetNode(mci::Tokenize(cAdcDod));

    /* instantiate remote signal entity */
    isig::SignalSourceSharedPtr signal = mci::CreateRemoteSignal(node);

    /* adc signal is "data on demand" signal whose basic data type is signed 16 bit */
